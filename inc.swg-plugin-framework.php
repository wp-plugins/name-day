 ...
 */
class NameDay_SWGPluginFramework {
	...
	function PrepareStandardSidebar() {
		$this->AddContentSidebar(__('Plugin',$this->g_info['ShortName']), '
			<ul>
				...
				<li><a class="lhome" href="http://wordpress.org/extend/plugins/profile/thomaz">'.__('Other Plugins I\'ve Written',$this->g_info['ShortName']).'</a></li>
			</ul>			
			');
		$this->AddContentSidebar(__('Do you like this plugin?',$this->g_info['ShortName']), '
			...
			<ul>
				<li><a class="lpaypal" href="http://dev.liajnad.se/donation/paypal/">'.__('Donate via PayPal',$this->g_info['ShortName']).'</a></li>
			</ul>			
			');
	}
	...
	function GetGeneratedOptionsPage() {
		...
		<style type="text/css">
			...
			td.right a.lhome { background-image:url(<?php echo $this->GetBase64IconURL('wp.png'); ?>); }
